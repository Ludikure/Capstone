...
spacex_df = pd.read_csv("/home/bojan/Documents/ve_bm/Captstone Project/Module 3/spacex_launch_dash.csv")
...
def get_scatter_plot(entered_site, slider_range):
    ...
    fig = px.scatter(
        ...
        title=f'Correlation between Payload and Success for Site {entered_site}' if entered_site != 'ALL' else 'Correlation between Payload and Success for All Sites'
        )
    return fig 
